...
#================================================================
#
# Function: opCOPY(primary, masked, mask)
#
...
#
#================================================================
def opCOPY(primary, masked = False, mask = None):

    if masked:
        return opAND(np.array(primary, copy=True), mask) 
    else:
...
def opATOP(primary, secondary, maskone, masktwo):
    ...
    #I2 AND NOT(M2)
    RHS = opAND(secondary, opNOT(maskone))
...
def opCLEAR(primary, secondary, maskone, masktwo):
    ...
    #and the mask and the image
    return opAND(opAND(primary, opNOT(maskone)), maskone)